...
/**
 * Denominations related functions
 */
Lib.vecStandardDenominations = CoinJoinDenominations.vecStandardDenominations;
//orig: static constexpr std::array<CAmount, 5> GetStandardDenominations() { return vecStandardDenominations; }
Lib.GetStandardDenominations = CoinJoinDenominations.GetStandardDenominations;
//orig: static constexpr CAmount GetSmallestDenomination() { return vecStandardDenominations.back(); }
Lib.GetSmallestDenomination = CoinJoinDenominations.GetSmallestDenomination;
//orig: static constexpr bool IsDenominatedAmount(CAmount nInputAmount) { return AmountToDenomination(nInputAmount) > 0; }
Lib.IsDenominatedAmount = CoinJoinDenominations.IsDenominatedAmount;
//orig: static constexpr bool IsValidDenomination(int nDenom) { return DenominationToAmount(nDenom) > 0; }
Lib.IsValidDenomination = CoinJoinDenominations.IsValidDenomination;
//orig: static constexpr int AmountToDenomination(CAmount nInputAmount)
Lib.AmountToDenomination = CoinJoinDenominations.AmountToDenomination;
//orig: static constexpr CAmount DenominationToAmount(int nDenom)
Lib.DenominationToAmount = CoinJoinDenominations.DenominationToAmount;
//orig: static std::string DenominationToString(int nDenom);
Lib.DenominationToString = CoinJoinDenominations.DenominationToString;
