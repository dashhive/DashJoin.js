...
//	await Logger.initialize('util');
//	const { log } = Logger;
//	let dboot = await dashboot.load_instance('base2');
//	const username = 'db2f8fd1037a469ea938018c122859f0';
//	let submission = {
//		txid: '0c98b8007905ee3c06de2bb410f74e0a030292c2c0df7061640a43ccd4b813ac',
//		vout: 0,
//		address: 'yS8nBwi6KoiEpfXvmCUjaeRWEC3n41koXq',
//		scriptPubKey: '76a9143fcc52da5b267aa5351b290e34c16aacdf44054288ac',
//		amount: 100001,
//	};
//	let tx = await SigScript.extractSigScript(
//		dboot,
//		username,
//		{
...
//			privateKey: await dboot.get_private_key(username, submission.address),
//		},
//		100001,
//		true
//	);
//
//	dd(tx);
//	let sig = tx.inputs[0]._scriptBuffer;
//	let keyIn = Script.buildPublicKeyIn(sig, 0x81);
//	//dd(keyIn);
//	log(tx);
//	dd(tx);
//})();
