...
- When ERR_INVALID_COLLATERAL message is received, mark the transaction used
  then resend the dsa message
- Study, document, and write the code for the flow after the `dsi` packet has
  been sent and processed by the masternode.
  - see:
    [The CoinJoin docs](https://docs.dash.org/projects/core/en/stable/docs/reference/p2p-network-privatesend-messages.html#dsi)
